...
export const PROGRAMA = [
  ...
  { ini: '8:45 p. m.', fin: '9:00 p. m.', dur: '0:15', bloque: 'recepcion',
    ...
    // Sin canción, pero el DJ tiene que hacer algo: por eso sale igual en su hoja
    cue: 'Micrófono en la mano y MÚSICA FUERA mientras hablan.',
    musica: [] },
  ...
  { ini: '10:20 p. m.', fin: '11:00 p. m.', dur: '0:40', bloque: 'recepcion', clave: true,
    ...
    musica: [{ momento: 'Pista abierta', cancion: 'Lo que pida la pista', quien: DJ, suave: true,
      nota: 'Sin guion. Si alguna mesa se quedó sin corear la suya en la dinámica de las botellas, es el momento de soltarla.' }] },
